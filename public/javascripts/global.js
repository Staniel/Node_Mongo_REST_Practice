...
function editUserInfo(event) {
    ...
    //Populate edit Box
    $('#editUser fieldset input#editUserName').val(thisUserObject.username),
    $('#editUser fieldset input#editUserEmail').val(thisUserObject.email),
    $('#editUser fieldset input#editUserFullname').val(thisUserObject.fullname),
    $('#editUser fieldset input#editUserAge').val(thisUserObject.age),
    $('#editUser fieldset input#editUserLocation').val(thisUserObject.location),
    $('#editUser fieldset input#editUserGender').val(thisUserObject.gender)
...
function editUser(event) {
    ...
    if (confirmation === true) {
        ...
        $.ajax({
            type: 'PUT',
            url: '/users/edituser/' + $("#userList").attr('rel'),
            data: editedUser,
            dataType: 'JSON'
